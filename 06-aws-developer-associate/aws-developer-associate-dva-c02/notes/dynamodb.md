...
- **Partition Key (Hash)**
    ...
    ![Untitled](dynamodb/untitled.png)
...
- **Partition Key (Hash) + Sort Key (Range)**
    ...
    ![Untitled](dynamodb/untitled-1.png)
...
![Untitled](dynamodb/untitled-2.png)
...
- Examples
    ...
    ![Untitled](dynamodb/untitled-3.png)
    
    ![Untitled](dynamodb/untitled-4.png)
    
    ![Untitled](dynamodb/untitled-5.png)
    
    ![Untitled](dynamodb/untitled-6.png)
...
- Example
    ...
    ![Untitled](dynamodb/untitled-7.png)
...
- Example
    ...
    ![Untitled](dynamodb/untitled-8.png)
...
![Untitled](dynamodb/untitled-9.png)
...
- Stream records can be:
    - Read directly by AWS Lambda (using Event Source Mapping)
        ...
        ![Untitled](dynamodb/untitled-10.png)
    ...
    - Read by KCL as a stream (requires **Kinesis Adapter**)
        ...
        ![Untitled](dynamodb/untitled-11.png)
...
- Working
    ...
    ![Untitled](dynamodb/untitled-12.png)
...
- **All-or-nothing operation** (the change happens to all the items across multiple tables or none of the items). If any operation in the transaction fails, the entire transaction is failed.
...
- Example
    ...
    ![Untitled](dynamodb/untitled-13.png)
...
- Write types in DynamoDB
    ...
    ![Untitled](dynamodb/untitled-14.png)